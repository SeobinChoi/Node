    ...
    <div data-testid="ops-ai-report" className="mt-5 border-t border-slate-200 pt-4">
      ...
      <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-end">
        <div className="w-full sm:w-72">
          ...
          <select id="ops-document-type" data-testid="ops-document-type" value={documentType} onChange={(event) => handleDocumentTypeChange(event.target.value as OpsRadarDocumentType)} className="mt-1 w-full rounded border border-slate-300 bg-white px-2 py-2 text-sm text-slate-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-700">
