...
- The first-session public-demo tutorial clicks only deterministic local controls (tool/mode selectors and Ops Radar evaluation); AI generation remains an explicit user action and is never auto-triggered by the tour.
